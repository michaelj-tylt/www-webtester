...
export const Section: FC<SectionProps> = ({ 
  ...
  return (
    <section 
      className={`min-h-screen flex items-center justify-center ${getBgClass()} ${className}`}
    >
      <div className="w-full flex items-center justify-center py-16 sm:py-20 md:py-24">
        {children}
      </div>
    </section>
  );
